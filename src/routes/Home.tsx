  ...
  return (
    <div className="flex-col w-full pb-24">
      <Container>
        <div className="my-8">
          <h2 className="text-3xl  text-center md:text-left md:text-6xl">
            <span className=" text-outline text-slate- font-extrabold md:text-8xl">
              AI Superpower
            </span>
        ...
        {/* image section */}
        <div className="w-full mt-4 rounded-xl bg-gray-100 h-[550px] drop-shadow-md overflow-hidden relative">
          <img
      ...
      <Container className="py-8 space-y-8">
        ...
        <div className="col-span-1 md:col-span-3 overflow-hidden flex justify-center">
  <img
    src="/assets/img/office3.jpg"
    alt=""
    className="w-full h-[36rem] rounded-md object-cover scale-90"
  />
</div>
